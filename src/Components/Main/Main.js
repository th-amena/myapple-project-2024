        ...
        <section className="alert-section top-50">
           <div className="container">
              ...
              <div className="alert-text">
                 ...
                 online and get fast, free delivery. If you need help finding
                 the right product or have a question on your order, chat online
                 with a Specialist or call 1-800-MY-APPLE.
                 <br />
              ...
              <div className="row">
                 ...
                 <div className="right-side-wrapper col-sm-12 col-md-6">
                    <div className="right-side-container">
                       ...
                       <div className="description-wraper">
                          Pay for your next iPhone over time, interest-free with
                          Apple Card.
                       </div>
                       <div className="links-wrapper">
                          <ul>
